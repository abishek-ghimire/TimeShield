...
[![Tests](https://img.shields.io/badge/smoke%20tests-38%20passing-2ea44f)](tests/smoke.test.mjs)
...
1. Download **`TimeShield-v2.2.0.zip`** from the [v2.2.0 release](https://github.com/abishekgh-6/TimeShield/releases/tag/v2.2.0).
...
The current downloadable release is **[TimeShield v2.2.0](https://github.com/abishekgh-6/TimeShield/releases/tag/v2.2.0)**. The release includes `TimeShield-v2.2.0.zip` and is intended for unpacked installation while the project is distributed through GitHub.
