class SleepBlockPage {
    ...
    addPauseBlockButton() {
        ...
        // Every duration requests a visible verification challenge instead of pausing silently.
        document.querySelectorAll('.duration-btn').forEach(btn => {
            btn.addEventListener('click', async () => {
                ...
                try {
                    const response = await chrome.runtime.sendMessage({ action: 'pauseBlocking', durationMs, pauseContext: 'general' });
